...
df_loc = pd.read_csv(r"E:\Medilab (1)\Medilab\survey.csv")
...
file_handler = open(r"E:\Medilab (1)\Medilab\survey.csv")
...
df_loc1 = pd.DataFrame(df_loc,columns=['latitude'])
print(df_loc1)
str=df_loc1['latitude'].str[:-1]
print(str) 
...
#for k, col in zip(unique_labels, colors):
    ...
    #xy = x_scaled [class_member_mask & score_samples_mask]
...
df_new1.to_csv(r'E:\Medilab (1)\Medilab\survey.csv')
print(df_new1)
...
g_label_encoder.fit_transform(["Female"])
